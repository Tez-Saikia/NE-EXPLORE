...
import MizThirdPkgImg from "./MizThirdPkgImg/MizThirdPkgImg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={MizThirdPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Mizoram/Mizoram Solomon's Temple")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          A non-denominational church founded by Dr. L.B. Sailo in 1984 built Solomon’s Temple. They are known as ‘Kohhran Thianghlim’ locally andthe “Holy Church” in English
          </h1>
          <h1 className="left-[5.8rem] top-[15rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Solomon's Temple, the largest church in Mizoram, located in the Kidron Valley, just 10 kilometres from Aizawl.
          </h1>
          <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          It is an architecturally amazing religious structure with a calm and serene atmosphere both within and outside.One feels at peace within its premises whether inside the church or while sitting in the garden
          </h1>
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
           It's locally known as 'Kohhran Thianghlim' or 'The Holy Church', the idea of the temple came in the dream of Dr L.B. Sailo, the founder of Kohhran Thianghlim Church, who saw a vision in which he was informed of the design and structure of the temple.
          </h1>
        </div>
      </div>
      {/* Footer */}
