...
import "./Assam.css"
import AssamData from './AssamData';
...
function Assam() {
  ...
  return (
    ...
    <video
      ...
      muted
    >
      <source src={VDOS[6]} type="video/mp4" />
    </video>
    <img
    ...
    <div className="z-40 relative  top-[10rem]  text-[2rem]">
      ...
      <h1 className="text-white absolute  font-sans text-[3rem] font-extrabold ml-[29rem] mt-[3rem]">
        <span className="text-yellow-500">Assam</span> Tour Packages!
      </h1>
      ...
      <div className="relative">
        ...
        <div className="relative">
          <div className="absolute top-[-44rem] left-[13rem] w-[68rem] bg-blue-100 p-4 rounded-[1rem]">
            ...
            Assam Tour Packages | Upto 40% Off
            </h1>
            <h1 className="text-[1rem] font-sans text-[#555555] mt-2">
            Assam, a gem in India's northeastern region, is where natural beauty meets cultural richness. Our Assam tour introduces you to tea gardens that produce the world-renowned Assam tea and offer you a glimpse of the mighty Brahmaputra River too.
            </h1>
          </div>
        </div>
      </div>
    ...
    <div className="z-[999] absolute top-[192rem] left-[7rem]">
      <h1 className="-mt-16 absolute ml-6 font-sans font-bold text-xl text-[#434242]">
        Popular Assam Attractions:
      </h1>
      <img className="w-[36rem] h-[24rem] rounded-[29px]" src={PkgImg.assam} alt="" />
      ...
      <h1 className="mt-[-7rem] absolute ml-[2.75rem] font-sans text-[1rem] text-white">
        {" "}
        Whether the tourists visiting is a first timer or the frequent visitor, Kaziranga can never fail to get under their skin. The presence of the Great Indian One-Horned Rhinoceros, upon which this sanctuary is formed is one good and the main reason to visit the park.
      </h1>
