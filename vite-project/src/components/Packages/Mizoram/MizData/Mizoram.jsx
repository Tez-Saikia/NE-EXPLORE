...
function Mizoram() {
  ...
  return (
    ...
    <video
      ...
      muted
    >
      <source src={VDOS[4]} type="video/mp4" />
    </video>
    <img
    ...
    <div className="z-40 relative  top-[10rem]  text-[2rem]">
      ...
      <h1 className="text-white absolute  font-sans text-[3rem] font-extrabold ml-[27rem] mt-[3rem]">
        <span className="text-yellow-500">Mizoram</span> Tour Packages!
      </h1>
      ...
      <div className="relative">
        ...
        <div className="relative">
          <div className="absolute top-[-44rem] left-[13rem] w-[68rem] bg-blue-100 p-4 rounded-[1rem]">
            ...
            Mizoram Tour Packages | Upto 40% Off
            </h1>
            <h1 className="text-[1rem] font-sans text-[#555555] mt-2">
            Also known as the 'Land of the Highlanders', Mizoram is a state tucked in the corners of North-east India and is famous for its dense bamboo jungles and lush green hills. The state is home to numerous waterfalls, deep valleys, picturesque villages and blue mountains.
            </h1>
          </div>
        </div>
      </div>
    ...
    <div className="z-[999] absolute top-[192rem] left-[7rem]">
      <h1 className="-mt-16 absolute ml-6 font-sans font-bold text-xl text-[#434242]">
        Popular Mizoram Attractions:
      </h1>
      <img className="w-[36rem] h-[24rem] rounded-[29px]" src={PkgImg.miz1} alt="" />
      ...
      <h1 className="mt-[-7rem] absolute ml-[2.75rem] font-sans text-[1rem] text-white">
        {" "}
        Would you try a canopy walk? Do you want the get-aways from the bustling sound of the city? if you love nature and lush green forest...visit Lalsavunga Park, Hlimen, just a 15 minutes drive from Aizawl City. You can watch chirping of birds... a fun-filled activity for nature lover.
      </h1>
