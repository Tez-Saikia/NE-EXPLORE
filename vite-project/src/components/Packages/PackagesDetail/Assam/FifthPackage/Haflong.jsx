...
import AsmFifthPkgImg from "./FifthPackageImages/AsmFifthPkgImg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={AsmFifthPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <div className="absolute left-[13rem] top-[9.3rem] bg-[#ffecca] w-[9rem] h-[2.6rem]">
              ...
              <h1 className="ml-[2.6rem] mt-[0.6rem] text-[#fea500]  absolute font-bold">
                No Cost EMI
              </h1>
            </div>
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Assam/Haflong Tour")}
            >
        ...
        <div className="w-[27.8rem] h-[7.0rem] left-[53.9rem] top-[45.4rem] absolute">
          ...
          <h1 className="left-[11.5rem] top-[3.8rem] absolute text-[#ff4c00] text-nowrap text-[1.4rem] font-medium font-['Inter']">
            Haflong,Assam
          </h1>
          <img
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          />
          <img
            className="w-[4.5rem] h-[4.4rem] left-[1.2rem] top-[29rem] absolute"
            src={Pkgimg[0]}
          />
          <h1 className=" left-[5.8rem] top-[8rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Visit the Haflong Lake a picturesque body of water nestled in the heart of Haflong town, which is known as the 'Switzerland of the East' due to its stunning landscapes. This natural lake is the centerpiece of Haflong, the only hill station in Assam, India.
          </h1>
          <h1 className="left-[5.8rem] top-[15rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Refresh in Panimoor Falls, a mesmerizing natural water cascade situated near Haflong, which is in the Dima Hasao District of Assam, India. This stunning waterfall is formed by the Kopili River, which takes a striking plunge over the rocks creating a splendid sight. 
          </h1>
          <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Jatinga : A small village located in the Dima Hasao district of Assam, India, known for the phenomenon of bird 'suicides'. Surrounded by serene hills and picturesque vistas, it falls under the greater region of Haflong, which is the only hill station in Assam.
          </h1>
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Try the unique Judima Wine, a local rice wine traditional to the Dimasa people, originates from Haflong, which is a picturesque hill station in Assam, India. Renowned for its unique flavor and cultural significance, Judima Wine is not just an alcoholic beverage but a symbol of hospitality and tradition.
          </h1>
        </div>
      </div>
      {/* Footer */}
