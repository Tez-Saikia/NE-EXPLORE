...
import MlSixthPkgImg from "./SixthPkgImg/MlSixthPkgImg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute left-[7.8rem] top-[18rem] flex justify-start items-end gap-3 z-20">
          ...
          <h1 className="text-[#212020] text-5xl font-semibold font-['Inter']">
            Mesmerising Mawlynnong Village
          </h1>
        </div>
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={MlSixthPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Meghalaya/Mesmerising Mawlynnong Village")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <h1 className=" left-[5.8rem] top-[8rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Living root bridges: A famous attraction is the Nohwet Living Root
            Bridge, which was created by weaving the roots of the Ficus Elastica
            tree around a framework.
          </h1>
          <h1 className="left-[5.8rem] top-[16rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            A beautiful waterfall located in the forests on the way from Dawki
            to the village.
          </h1>
          <h1 className=" left-[5.8rem] top-[23rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Church of the Epiphany: A centuries-old church that is a beautiful
          ...
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Mawlynnong is known as one of the cleanest villages in Asia. The
            Khasi tribe of the region live a sustainable lifestyle by: recycling
            waste, harvesting rainwater, using solar energy, and not using
            plastic.
          </h1>
        </div>
      </div>
...
export default CleanestVillage;
