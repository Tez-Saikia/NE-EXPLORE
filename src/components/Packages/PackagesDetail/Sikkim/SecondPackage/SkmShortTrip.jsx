...
import SkmSecondPkgImg from "./secondPkgImg/SkmSecondPkg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={SkmSecondPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Sikkim/Short Trip To Sikkim")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <h1 className=" left-[5.8rem] top-[9rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Gangtok-Some of the top attractions include the Nathula Pass, Tsomgo
            Lake, Rumtek Monastery and more.
          </h1>
          <h1 className="left-[5.8rem] top-[16rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Yuksom- A peaceful hamlet in west Sikkim, it is called the meeting
            place of three Lamas.
          </h1>
          <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Momo- Originating from Tibet, momos are a popular snack across
            India. You will find some of the most delicious versions of this
            dish in Sikkim, complete with a variety of fillings like cheese,
            tofu and more.
          </h1>
          <h1 className=" left-[5.8rem] top-[29.6rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Phagshapa- Pork fat is stewed with radish and dry chilies to make
            this fabulous Sikkimese dish. It is one of the most-loved
            preparations in Sikkim.
          </h1>
        </div>
      </div>
      {/* Footer */}
