...
import Pkg1Imgs from "./FirstPkgImgs/index";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={Pkg1Imgs[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Nagaland/HornBill Package")}
            >
              <h1 className="text-white text-2xl font-black font-sans">
                Book Now
              </h1>
            </button>
          </div>
        ...
        <div className="w-[27.8rem] h-[7.0rem] left-[53.9rem] top-[45.4rem] absolute">
          ...
          <h1 className="left-[12rem] top-[3.8rem] absolute text-[#ff4c00] text-2xl font-medium font-['Inter']">
            Kohima, Nagaland
          </h1>
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <img
            ...
            src={Pkgimg[0]}
          />
          <h1 className="w-[64.2rem] left-[5.8rem] top-[8.8rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Immerse yourself in the unique and colourful culture of the Naga
            Tribes with authentic food, folklore, music and lifestyle at the
            famous Hornbill Festival
          </h1>
          <h1 className="w-[64.2rem] left-[5.8rem] top-[16rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Relish your taste buds with the authentic Naga cuisine and the
            locally brewed rice beer called Zutho
          </h1>
          <h1 className="w-[64.2rem] h-[3.6rem] left-[5.8rem] top-[22.9rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Experience Naga morungs the traditional huts that were used as
            dormitories back in the day.
          </h1>
          <h1 className="w-[64.2rem] h-[3.6rem] left-[5.8rem] top-[29.1rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            The Hornbill Festival is also a culinary journey, with food stalls
            offering traditional Naga dishes such as smoked meats, bamboo shoot
            curries, and Naga chilli sauces.
          </h1>
        </div>
      </div>
      {/* Footer */}
