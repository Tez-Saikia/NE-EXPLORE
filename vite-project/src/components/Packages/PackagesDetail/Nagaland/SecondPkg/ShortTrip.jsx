...
import Pkgimg from "../../imgs/index";
import Nav from "@/components/Header/Nav";
import Logo from "../../../../../assets/Logo.png";
import PkgDetailFooter from "../../PkgDetailFooter";
import { FaHandHoldingUsd } from "react-icons/fa";
import { useNavigate } from "react-router-dom";
import SecondPkg from "./secondPkgImgs";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={SecondPkg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Nagaland/Short Trip Package")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <img
            ...
            src={Pkgimg[0]}
          />
          <h1 className=" left-[5.8rem] top-[8.8rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Trip Full of Historical Importance, Lush green Forests, Beautiful
            Valleys and Museums.
          </h1>
          <h1 className=" left-[5.8rem] top-[16rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Come upon to the Land of Festivals “Nagaland” which has Festivals
            Lined up every Month.
          </h1>
          <h1 className="left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Unleash your wanderlust by exploring the unexplored part of India
            and Indulge in Local Experience & Get to know the Naga Community.
          </h1>
          <h1 className="left-[5.8rem] top-[29.1rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Visit the ruins of World War 2 and Pay Homage to the Heroes of War,
            Feel the importance of Forest and get motivated to preserve it.
          </h1>
        </div>
      </div>
      {/* Footer */}
