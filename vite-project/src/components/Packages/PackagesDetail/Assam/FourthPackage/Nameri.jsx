...
import AsmFourthPkgImg from "./FourthPkgImg/AsmFourthPkgImg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={AsmFourthPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Assam/Nameri Tour")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          Nameri is known for its elephants, tigers, leopards, gaurs, wild pigs, and sambars. You can see wildlife on a safari or while rafting on the Jia Bharali River.
          </h1>
          <h1 className="left-[5.8rem] top-[15rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Birds: Nameri is home to over 350 species of birds, including the white-winged wood duck, the state bird of Assam. You can see birds while rafting on the Jia Bharali River.
          </h1>
          <h1 className=" left-[5.8rem] top-[23rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Jungle treks: You can go on jungle treks to see rare birds and other wildlife.
          </h1>
          <h1 className=" left-[5.8rem] top-[28rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Nameri is home to some of the endangered species like white winged wood duck, Sloth Bear, Tiger Leopard, Clouded Leopard, Indian Wild Dog etc four varieties of Hornbill and many other winged species. The other reason Nameri is famous for, is the herds of elephants.
          </h1>
        </div>
      </div>
      {/* Footer */}
