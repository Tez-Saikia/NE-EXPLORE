...
import FifthPkgImg from "./FifthPkgImg/MizFifthPkgImg";
    ...
    <div className="ml-[3rem] relative z-30">
      ...
      <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
        <img
          ...
          src={FifthPkgImg[currentImageIndex]}
      ...
      <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
        <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
          ...
          <button
            ...
            onClick={() => navigate("/Packages/Mizoram/Sailam")}
          >
      ...
      <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
        ...
        It is a hotspot for different species of birds located in Sailam village. The range of bird species there is amazing. Since long, birds in Mizoram are shy to come out due to fear of traps and hunters.
        </h1>
        <h1 className="left-[5.8rem] top-[15rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
        Sailam villagers formed a society called Sailam Ecological Conservation Society which has been working at educating children and villagers about the importance of the conservation of their flora and fauna.
        </h1>
        <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
        Experience the thrill of a life time with the best bird watching tour in Mizoram. The bird watching tour is a great opportunity to see the rarest of birds in their natural habitat.
        </h1>
        <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
        The village have one reserved forest ‘Zotheihuan’ under the control of the village council which is a body of elected representatives equivalent to the gram panchayat.
        </h1>
      </div>
    </div>
    {/* Footer */}
