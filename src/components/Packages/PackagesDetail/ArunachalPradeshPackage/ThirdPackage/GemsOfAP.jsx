...
import ApThirdPkgImg from "./ThirdPkgImg/ApThirdPkgImgs";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={ApThirdPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Arunachal Pradesh/Gems Of Arunachal Pradesh")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <img
            ...
            src={Pkgimg[0]}
          />
          <h1 className=" left-[5.8rem] top-[10rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Witness the crystal-clear waters of Sangetsar Lake, that mirror the
          ...
          <h1 className="left-[5.8rem] top-[15rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Pay respect to the Jaswant Garh War Memorial, a memorial dedicated
            to Rifleman Jaswant Singh Rawat, who heroically fought and held off
            Chinese forces.
          </h1>
          <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Get a unique and spiritual experience during your visit to Urgelling
            Gompa, the birthplace of the 6th Dalai Lama, Tsangyang Gyatso.
          </h1>
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Admire the key border crossing between India and China, during your
            visit to the Bumla Pass, which is significant in the context of the
