...
import AsmSecondPkgImg from "./SecondPkgImg/AsmSecondPkgImg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={AsmSecondPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Assam/Guwahati Tour")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          Get to visit Kamakhya Temple, one of the most revered Shakti Peeths in the world, is perched atop a hill with stunning views of the mighty Brahmaputra River.
          </h1>
          <h1 className="left-[5.8rem] top-[15rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          The Saraighat Bridge is a rail-cum-road bridge in Assam, India that crosses the Brahmaputra River. It's a vital link between the northeast region of India and the rest of the country
          </h1>
          <h1 className=" left-[5.8rem] top-[21rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Enjoy in the Amusement Park, it has a lot of rides and a great water park which makes it an ideal place to spend some good time with family and friends. This place also has a coffee shop and a restaurant where you can eat a sumptuous lunch after a tiring day.
          </h1>
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Regional Science Center : Here science comes alive with a vibrant science park with an adjacent Prehistoric park,3D science movies, science shows. 
          </h1>
        </div>
      </div>
      {/* Footer */}
