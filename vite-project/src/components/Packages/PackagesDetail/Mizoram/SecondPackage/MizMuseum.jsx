...
import MizSecondPkgImg from "./SecondPkgImgs/MizSecondPkgImg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={MizSecondPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Mizoram/Mizoram State Museum")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          This museum displays the rich heritage of Mizoram.Along with the numerous archaeological artifacts, photographs and natural history specimens, an entire gallery here is dedicated to the Mizo tribes.
          </h1>
          <h1 className="left-[5.8rem] top-[15rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          The history, culture and tradition of the Mizo can clearly be seen from the objects of tools and implements, household materials, hunting and warfare as well as ornaments and textiles.
          </h1>
          <h1 className=" left-[5.8rem] top-[21rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          The Mizoram State Museum is essentially an ethnographic museum with multipurpose collections on display. There are five galleries: Textile Gallery, Ethnology Gallery, History Gallery, Anthropology, Zoology Gallery.
          </h1>
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          The State Museum started functions in a rented house. It was on July 1990 that a Museum Building was inaugurated and occupied. The Museum galleries are modernized and improved with the assistance of Indian Museum, Kolkata
          </h1>
        </div>
      </div>
      {/* Footer */}
