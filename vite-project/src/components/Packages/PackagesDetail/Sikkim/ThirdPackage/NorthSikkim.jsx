...
import SkmThirdPkgImgs from "./thirdPackageImgs/SkmThirdPkgImgs";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={SkmThirdPkgImgs[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Sikkim/North Sikkim Wonders")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <h1 className=" left-[5.8rem] top-[8rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Gurudongmar Lake, also known as "The Wish Lake," "Majestic Lake,"
            and the well-known truth "The Lake That Never Freezes," is a
          ...
          <h1 className="left-[5.8rem] top-[15rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Unleash your inner wanderer with breathtaking landscapes composed of
            mountains, waterfalls, forests, lakes, and monasteries.
          </h1>
          <h1 className=" left-[5.8rem] top-[23rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Travel to the tinsel town of Lachen, famous for its natural beauty
            amidst the mountains of North Sikkim
          </h1>
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Get a chance to visit the "most lovely settlement of Sikkim" -
            Lachung iknown for housing the prettiest apple, peach and apricot
            orchards
          </h1>
        </div>
      </div>
