...
function Meghalaya() {
  ...
  return (
    ...
    <video
      ...
      muted
    >
      <source src={VDOS[2]} type="video/mp4" />
    </video>
    <img
    ...
    <div className="z-40 relative  top-[10rem]  text-[2rem]">
      ...
      <h1 className="text-white absolute  font-sans text-[3rem] font-extrabold ml-[27rem] mt-[3rem]">
        <span className="text-yellow-500">Meghalaya</span> Tour Packages!
      </h1>
      ...
      <div className="relative">
        ...
        <div className="relative">
          <div className="absolute top-[-44rem] left-[13rem] w-[68rem] bg-blue-100 p-4 rounded-[1rem]">
            ...
            Meghalaya Tour Packages | Upto 40% Off
            </h1>
            <h1 className="text-[1rem] font-sans text-[#555555] mt-2">
            Meghalaya Holiday Packages - Meghalaya is one of those states in India that houses some of the most beautiful treasures of Mother Nature. Surrounded by lush green trees that are well-complemented by the pleasant climate the state truly is heaven on earth. A tour to Meghalaya experiences a lot of rainfall now and then that makes the greenery even more vibrant.
            </h1>
          </div>
        </div>
      </div>
    ...
    <div className="z-[999] absolute top-[192rem] left-[7rem]">
      <h1 className="-mt-16 absolute ml-6 font-sans font-bold text-xl text-[#434242]">
        Popular Meghalaya Attractions:
      </h1>
      <img className="w-[36rem] h-[24rem] rounded-[29px]" src={PkgImg.Mgl} alt="" />
      ...
      <h1 className="mt-[-7rem] absolute ml-[2.75rem] font-sans text-[1rem] text-white">
        {" "}
        Arguably the most famous icon of Meghalaya is found here the Nohwet Living Root Bridge. The bridge was created by weaving the roots of the Ficus Elastica tree around a framework and continuing this process for generations. 
      </h1>
