...
import firstPkgImgs from "./firstPkgImgs";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={firstPkgImgs[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Sikkim/Exclusive Sikkim Trip")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <h1 className=" left-[5.8rem] top-[8rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Make your dreams come true at the sacred Wishing Lake of
            Khecheopalri in Pelling, as you express your deepest desires.
          </h1>
          <h1 className="left-[5.8rem] top-[15rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Prepare to be mesmerized by the kaleidoscope of colours in the
            Sikkim Valley of Flowers, Yumthang Valley, surrounded by the
          ...
          <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Get captivated by the vibrant blooms of Sikkim Valley of Flowers,
            Yumthang Valley, enveloped by the pristine landscapes of
            snow-covered Himalayas.
          </h1>
          <h1 className=" left-[5.8rem] top-[29.6rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Gear up for a thrilling adventure as you dive into the timeless
            beauty of Sikkim's enchanting landscapes.
          </h1>
        </div>
      </div>
      {/* Footer */}
...
export default ExclusiveSikkimTrip;
