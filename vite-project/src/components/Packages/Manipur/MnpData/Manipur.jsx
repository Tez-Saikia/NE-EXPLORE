...
function Manipur() {
  ...
  return (
    ...
    <video
      ...
      muted
    >
      <source src={VDOS[3]} type="video/mp4" />
    </video>
    <img
    ...
    <div className="z-40 relative  top-[10rem]  text-[2rem]">
      ...
      <h1 className="text-white absolute  font-sans text-[3rem] font-extrabold ml-[27rem] mt-[3rem]">
        <span className="text-yellow-500">Manipur</span> Tour Packages!
      </h1>
      ...
      <div className="relative">
        ...
        <div className="relative">
          <div className="absolute top-[-44rem] left-[13rem] w-[68rem] bg-blue-100 p-4 rounded-[1rem]">
            ...
            Manipur Tour Packages | Upto 40% Off
            </h1>
            <h1 className="text-[1rem] font-sans text-[#555555] mt-2">
            Manipur Holiday Packages - Browse through a wide range of Manipur packages with exciting offers at Thrillophilia. Book customized Manipur travel packages with exciting deals & offers. Manipur attracts a ton of adventure enthusiasts with a wide range of thrilling activities. You can embark on trekking expeditions to the Dzukou Valley, surrounded by green hills adorned with Dzukou Lillies that change colours in every season.
            </h1>
          </div>
        </div>
      </div>
    ...
    <div className="z-[999] absolute top-[156rem] left-[7rem]">
      <h1 className="-mt-16 absolute ml-6 font-sans font-bold text-xl text-[#434242]">
        Popular Manipur Attractions:
      </h1>
      <img className="w-[36rem] h-[24rem] rounded-[29px]" src={PkgImg.Mnp} alt="" />
      ...
      <h1 className="mt-[-7rem] absolute ml-[2.75rem] font-sans text-[1rem] text-white">
        {" "}
        The Kangla is a revered spot for the people of Manipur, reminding them of the days of their independence. It is a sacred place to the Meiteis. The Kangla is being proposed to be declared as a UNESCO World Heritage Site, for which there are discussions ongoing in the Indian Parliament.
      </h1>
