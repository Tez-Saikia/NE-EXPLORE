...
import ApSecondPkgImg from "./SecondPkgImg/ApSecondPkgImg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute left-[7.8rem] top-[18rem] flex justify-start items-end gap-3 z-20">
          ...
          <h1 className="text-[#212020] text-5xl font-semibold font-['Inter']">
            Nirvana & Dirang Sightseeing Tour
          </h1>
        </div>
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={ApSecondPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Arunachal Pradesh/Nirvana with Dirang Sightseeing")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <h1 className=" left-[5.8rem] top-[8rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Unleash your wanderlust and explore the green wonder of Northeast
            India, Meghalaya with a memorable road journey.
          </h1>
          <h1 className="left-[5.8rem] top-[16rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Explore the mesmerizing waterfalls roaring and falling in the lush
            and steep green valley of Meghalaya.
          </h1>
          <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Bless your eyes with a stunning view of Umiam Lake, a majestic-man
            made reservoir that expands over an area of 222 square kilometres.
          </h1>
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Stop over at the oldest and the second-largest monastery in the
            world, the Tawang Monastery standing tall with colorful prayer flags
            and panoramic views.
          </h1>
        </div>
      </div>
...
export default NirvanaAndDirang;
