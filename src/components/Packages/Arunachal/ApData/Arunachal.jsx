...
function Arunachal() {
  ...
  return (
    ...
    <video
      ...
      muted
    >
      <source src={VDOS[5]} type="video/mp4" />
    </video>
    <img
    ...
    <div className="z-40 relative  top-[10rem]  text-[2rem]">
      ...
      <h1 className="text-white absolute  font-sans text-[3rem] font-extrabold ml-[21rem] mt-[3rem]">
        <span className="text-yellow-500">Arunachal Pradesh</span> Tour Packages!
      </h1>
      ...
      <div className="relative">
        ...
        <div className="relative">
          <div className="absolute top-[-44rem] left-[13rem] w-[68rem] bg-blue-100 p-4 rounded-[1rem]">
            ...
            Arunachal Pradesh Tour Packages | Upto 40% Off
            </h1>
            <h1 className="text-[1rem] font-sans text-[#555555] mt-2">
            Arunachal Pradesh is a destination filled with adventure, culture, and natural beauty. Explore through Tawang, Bomdila, and Dirang, where you visit the magnificent Tawang Monastery. You can also drive through the stunning Sela Pass, and experience the history at JaswantGarh War Memorial. 
            </h1>
          </div>
        </div>
      </div>
    ...
    <h1 className="absolute z-[999] mt-[45rem] ml-[13rem] text-[1rem] font-sans text-gray-600">
      Let's Explore Arunachal Pradesh
    </h1>
    ...
    <div className="z-[999] absolute top-[192rem] left-[7rem]">
      <h1 className="-mt-16 absolute ml-6 font-sans font-bold text-xl text-[#434242]">
        Popular Arunachal Pradesh Attractions:
      </h1>
      <img className="w-[36rem] h-[24rem] rounded-[29px]" src={PkgImg.arunachal2} alt="" />
      ...
      <h1 className="mt-[-7rem] absolute ml-[2.75rem] font-sans text-[1rem] text-white">
        {" "}
        Sela Pass is a high-altitude mountain pass located in the Tawang, Arunachal Pradesh. The pass is known for its scenic beauty and is surrounded by snow-capped mountains, glacial lakes, and picturesque valleys.
      </h1>

      <img
        className="absolute h-[11rem] w-[18rem] ml-[63rem] mt-[-22rem] rounded-[1.5rem] z-[99]"
        src={PkgImg.arunachal}
        alt=""
      />
      <img
        className="absolute h-[11rem] w-[18rem] ml-[63rem] mt-[-10rem] rounded-[1.5rem] z-[99]"
        src={PkgImg.arunachal1}
        alt=""
      />
    </div>
