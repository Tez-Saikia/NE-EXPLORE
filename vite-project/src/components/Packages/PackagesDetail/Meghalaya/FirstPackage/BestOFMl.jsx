...
import MlFirstImg from "./FirstPkgImg/MlFirstImg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={MlFirstImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Meghalaya/Best of Meghalaya")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <h1 className=" left-[5.8rem] top-[8rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Explore Meghalaya's lush landscapes and vibrant culture, where every
            step unveils a world of natural wonders and rich traditions.
          </h1>
          <h1 className="left-[5.8rem] top-[15rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Discover the rich history of Arwah Cave, which served as a natural
            shelter for indigenous tribes and holds archaeological treasures,
          ...
          <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Witness the majestic one-horned rhinoceros, an iconic symbol of
            Kaziranga National Park, as you embark on a thrilling safari through
            its vast grasslands and wetlands.
          </h1>
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Explore the Elephant Falls, where crystal-clear waters cascade
            through three tiers, surrounded by lush greenery and enhancing its
            natural beauty.
          </h1>
        </div>
      </div>
