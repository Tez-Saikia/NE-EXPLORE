...
import TripuraPkgSecondImg from "./SecondPkgImg/TripuraPkgImg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={TripuraPkgSecondImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Tripura/Jampui Hill Tour")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <h1 className=" left-[5.8rem] top-[8rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Panoramic views: The hill range offers views of the valley and
            villages of Mizoram, the Chittagong Hill Tracts, and other hill
            ranges. The highest peak, Betlingchip, is 3,600 feet high.
          </h1>
          <h1 className="left-[5.8rem] top-[16rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Sunrise and sunset: The hill range offers delightful views of the
            sunrise and sunset.
          </h1>
          <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            The Lushai tribes that live in the hill range have a distinct
            cultural identity. You can stay with local people in "paying guest"
            accommodations to learn about their culture.
          </h1>
          <h1 className=" left-[5.8rem] top-[30rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Laser light show: You can see the Ujjayanta Palace come alive with a
            laser light show and soundscapes.
          </h1>
        </div>
      </div>
      {/* Footer */}
