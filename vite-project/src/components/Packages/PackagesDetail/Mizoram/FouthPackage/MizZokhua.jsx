...
import MizFourthPkgImg from "./FourthPkgImg/FouthPkgImg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={MizFourthPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Mizoram/Zokhua - Typical Mizo Village")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          In Falkawn, about 18 km to the south of Aizawl, atypical Mizo village has been created on a hillock by the Department of Art & Culture, Mizoram. 
          </h1>
          <h1 className="left-[5.8rem] top-[14rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          It typifies the Lusei village of the olden days comprising the houses of the chief, the chief elder, the blacksmith and his workshop, the common citizen including the widow whom the society always treated with special care, and the bachelor's dormitory or Zawlbuk
          </h1>
          <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          A large stone has also been erected here commemorating seven Mizo patriots ‘who laid down their lives against British colonisation’.
          </h1>
          <h1 className=" left-[5.8rem] top-[30rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
           Experience the beautiful typical village of Mizoram.
          </h1>
        </div>
      </div>
      {/* Footer */}
