...
import fifthPkgImgs from "./fifthPkgImgs";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={fifthPkgImgs[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Nagaland/Explore The Beautiful Kohima")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <img
            ...
            src={Pkgimg[0]}
          />
          <h1 className=" left-[5.8rem] top-[8.4rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Take a stroll through the immaculately manicured gardens of the
            cemetery and pay your respects to the martyrs.
          </h1>
          <h1 className="left-[5.8rem] top-[14.6rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.1rem] tracking-wide">
            Observe the unique architecture of the church fusing with the
            surrounding hills and incorporating traditional elements of the Naga
            houses. The 16 feet high carved wood crucifix in the cathedral's
            central hall is one of Asia's largest crosses.
          </h1>
          <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.1rem] tracking-wide">
            The Kohima Zoo is home of the Nagaland state bird, the rare Tragopan
            bird. Apart from this, Mithun, a species of the wild buffalo and
            Golden Langurs are the highlight. Don't forget to catch a glimpse of
            the Asiatic Black Bear here.
          </h1>
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.1rem] tracking-wide">
            Observe rare birds such as Blyth's Tragopan, Rufous-breasted
            Accentor and the Dark-rumped Swift. Capture mesmerising views of the
            adjacent Dzuku Valley and Jafpu Peak from here. Stroll across the
            lush garden adorned with colourful flowers.
          </h1>
        </div>
      </div>
      {/* Footer */}
