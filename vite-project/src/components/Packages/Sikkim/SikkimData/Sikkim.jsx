...
import "./Sikkim.css";
import SikkimData from "./SikkimData";
  ...
  return (
    <div className="relative w-full h-screen">
      <video
        ...
        muted
      >
        <source src={VDOS[1]} type="video/mp4" />
      </video>
      <img
      ...
      <div className="z-40 relative  top-[10rem]  text-[2rem]">
        ...
        <h1 className="text-white absolute  font-sans text-[3rem] font-extrabold ml-[28rem] mt-[3rem]">
          <span className="text-yellow-500">Sikkim</span> Tour Packages!
        </h1>
      ...
      >
          ...
          <div className="relative">
            <div className="absolute top-[-44rem] left-[13rem] w-[68rem] bg-blue-100 p-4 rounded-[1rem]">
              <h1 className="text-[1.5rem] font-bold font-[math] text-[#555555]">
                Sikkim Tour Packages | Upto 40% Off
              </h1>
              <h1 className="text-[1rem] font-sans text-[#555555] mt-2">
              Sikkim Holiday Packages - Sikkim, India's first organic state and arguably the most beautiful, is known for its wealth of gems and its mystic past. This charming Himalayan country is a relatively unexplored area that continually entices visitors with its breathtaking landscapes. Every single area of Sikkim is a visual delight for hikers, from the views of the highest peaks in the world to the magnificent monasteries.
              </h1>
            </div>
          </div>
        </div>
        ...
        <div className="relative w-full h-screen">
          ...
          <div className="relative">
            ...
            <h1 className="z-[99] absolute mt-[-166rem] ml-[18rem] text-[2.4rem] font-sans font-extrabold text-white">
              Get special offers up to 50% Off!
            </h1>

            <h2 className="z-[99] absolute mt-[-162rem] ml-[18rem] text-[1rem] font-sans font-semibold text-white">
      ...
      <div className="z-[999] absolute top-[192rem] left-[7rem]">
        <h1 className="-mt-16 absolute ml-6 font-sans font-bold text-xl text-[#434242]">
          Popular Sikkim Attractions:
        </h1>
        <img className="w-[36rem] h-[24rem] rounded-[29px]" src={PkgImg.Skm} alt="" />
        ...
        <h1 className="mt-[-7rem] absolute ml-[2.75rem] font-sans text-[1rem] text-white">
          {" "}
          One of the most beautiful, pristine lakes in Sikkim, Gurudongmar lake sits in close proximity to the Tibetan and Chinese border in the north. The lake takes its name after the eminent guru Padmasambhava, who is believed to have traversed this region during his visit to Tibet.
        </h1>
