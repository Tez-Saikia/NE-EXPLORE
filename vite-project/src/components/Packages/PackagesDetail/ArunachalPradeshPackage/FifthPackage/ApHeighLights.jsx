      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute left-[7.8rem] top-[18rem] flex justify-start items-end gap-3 z-20">
          ...
          <h1 className="text-[#212020] text-5xl font-semibold font-['Inter']">
            Heighlights Of Arunachal Pradesh
          </h1>
        </div>
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={ApFifthPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Arunachal Pradesh/HighLights Of Arunachal Pradesh")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <h1 className=" left-[5.8rem] top-[8rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Discover Arunachal Pradesh, the largest state in Northeast India,
            renowned as the "Land of the Dawn-Lit Mountains"
          </h1>
          <h1 className="left-[5.8rem] top-[15rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Visit the Tawang Monastery, the largest Buddhist monastery in India
            and explore its impressive prayer halls, ancient scriptures, and
            sacred relics.
          </h1>
          <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Experience the stunning beauty of Shonga Tser Lake, also known as
            Madhuri Lake, named after Bollywood actress Madhuri Dixit due to its
            appearance in the film Koyla.
          </h1>
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Marvel at the breathtaking beauty of Nurunang Falls, surrounded by
            lush forests and dramatic rock formations, making it a perfect spot
