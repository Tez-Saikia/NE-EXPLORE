...
import MlFifthPkgImg from "./FifthPkgImg/MlFifthPkgImg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={MlFifthPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Meghalaya/Mystic Waterfalls")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <h1 className=" left-[5.8rem] top-[8rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Experience the thrill of being at one of the world's wettest places,
            Cherrapunji, and get Scotland-like views in Meghalaya's capital
            city, Shillong.
          </h1>
          <h1 className="left-[5.8rem] top-[16rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Witness the two-tiered Elephant Falls in Shillong, one of the most
          ...
          <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Marvel at Seven Sisters Falls in Meghalaya, where seven distinct
            streams create stunning views of the backdrop of verdant hills and
            vibrant flora.
          </h1>
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
            Trek to the Double-decker Living Root Bridge, which has withstood
            the test of time and is a reflection of skilled craft by the Khasi
            People.
          </h1>
        </div>
      </div>
