...
import TripuraFirstPkgImg from "./FirstPkgImg/TripuraFirstPkgImg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={TripuraFirstPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Tripura/The Ujjayanta Palace Tour")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          <img
            ...
            src={Pkgimg[0]}
          />
          <h1 className=" left-[5.8rem] top-[9rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Gardens : The palace is surrounded by large Mughal-style gardens with pools, walkways, and tiled floors. 
          </h1>
          <h1 className="left-[5.8rem] top-[15rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Museum : The palace houses the State Museum, which is the largest museum in northeast India. The museum has exhibits on art, crafts, and history from Tripura and the region. 
          </h1>
          <h1 className=" left-[5.8rem] top-[23rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Fountains : The palace has fountains that dance to music and light shows.
          </h1>
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          The magnificent tile floor, curved wooden ceiling and beautifully crafted doors are particularly notable. The palace is set with huge Mughal style gardens,beautified by pools and gardens and tiled floors. 
          </h1>
        </div>
      </div>
      {/* Footer */}
...
export default UjjayantaPalace