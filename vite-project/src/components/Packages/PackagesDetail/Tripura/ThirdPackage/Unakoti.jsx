...
import TripuraThirdPkgImg from "./ThirdPkgImgs/TripuraThirdPkgImg";
      ...
      <div className="ml-[3rem] relative z-30">
        ...
        <div className="absolute w-[43.7rem] h-[32rem] left-[7.1rem] top-[22.8rem] z-20">
          <img
            ...
            src={TripuraThirdPkgImg[currentImageIndex]}
        ...
        <div className="absolute w-[27.8rem]  left-[53.9rem] top-[26.2rem] z-20">
          <div className="bg-[#f8f7e4] h-[17.6rem] rounded-[0.6rem] border border-[#dedddd] shadow-lg relative p-4">
            ...
            <button
              ...
              onClick={() => navigate("/Packages/Tripura/Magnificent Unakoti")}
            >
        ...
        <div className="w-[74.6rem] h-[37rem] left-[7.6rem] top-[85.0rem] absolute">
          ...
          Unakoti, located in the Kailashahar region near Dharmanagar in Tripura, India, is an ancient historical site that features colossal rock reliefs, carvings, and stone idols of Hindu deities.
          </h1>
          <h1 className="left-[5.8rem] top-[14rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Kailashahar is a municipal council city located in the Unakoti district in the northeastern Indian state of Tripura. Historically, it was the ancient capital of the Tripuri kingdom and is known for its lush landscapes and rich cultural heritage. 
          </h1>
          <h1 className=" left-[5.8rem] top-[22rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Dighi Lake, also known as Rajbari Lake, is a picturesque water body located in the heart of Dharmanagar, a prominent town in the North Tripura district.
          </h1>
          <h1 className=" left-[5.8rem] top-[29rem] absolute text-black text-2xl font-normal font-['Inter'] leading-[2.3rem] tracking-wide">
          Kailashahar Palace, located in Kailashahar of Tripura, India, is an archaeological relic that speaks of the erstwhile princely state's heritage. 
          </h1>
        </div>
      </div>
      {/* Footer */}
